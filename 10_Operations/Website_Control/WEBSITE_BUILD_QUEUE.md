...
| HIGH | Oak Ridge Management | Sitemap architecture follow-through | Define eventual sitemap ownership and implementation path | NEEDS REVIEW | Codex | Confirm domain-local sitemap plan before implementation |
| HIGH | Oak Ridge Management | Sitemap file implementation | Add actual production sitemap when approved | NOT STARTED | Claude | Wait for sitemap scope approval |
| HIGH | CEH Standard | Public surface audit cleanup | Review page ownership, canonicals, metadata, and route assumptions | NOT STARTED | Codex | Audit live/source alignment before edits |
...
| MEDIUM | CEH Standard | Standards page inventory | List all current pages and missing pages | NOT STARTED | Claude | Inspect source and draft page matrix |
