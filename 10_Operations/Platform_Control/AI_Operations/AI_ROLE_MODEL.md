...
This document defines the practical role separation between the AI systems used in the ORM website operating system.

Its purpose is to:

- reduce duplication
- prevent conflicting guidance
- clarify which AI should be used for which type of task
...
The markdown operating system is the shared source of working truth.
